...
| 01 | Started; security baseline deployed | Enable Auth providers, decide Firebase environment split and Firestore region, then implement schemas and Rules tests |
